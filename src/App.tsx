        ...
        return (
            <div className="App bg-gray-800 h-screen w-full">
                <header className="bg-gray-800 w-full">
                    <img src={logo} className="w-24 mx-auto aspect-square animate-spin" alt="logo"/>
                    <div role="status" className="h-128 w-full flex items-center justify-center bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
